...
mm-delay 20 mm-link $2 $2 --meter-uplink --meter-uplink-delay -- sh -c "./src/salsify/salsify-sender -d /dev/video0 -p YU12 100.64.0.1  9090 1337 -r ${CC}" >log/sender.log 2>&1 &
